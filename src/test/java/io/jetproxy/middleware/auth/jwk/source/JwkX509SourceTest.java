...
//        """;
//
//        // IMPORTANT: embed it in raw JSON (no \\n escaping)
//        String jwksJson = """
//        {
//          "my-key": "%s"
//        }
//        """.formatted(certPem.replace("\n", "\\n"));
//
//        JwkX509Source source = new JwkX509Source("dummy", 60L);
//        Map<String, RSAPublicKey> keys = source.parseJwks(jwksJson);
//
//        assertEquals(1, keys.size());
//        RSAPublicKey key = keys.get("my-key");
//
//        assertNotNull(key);
